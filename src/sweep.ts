...
async function canRoundtrip(payload: string, c: SweepCase): Promise<boolean> {
...
async function findMax(c: SweepCase): Promise<number> {
	let low = 0; let high = 4000; // search up to ~4KB
	while (low < high) {
